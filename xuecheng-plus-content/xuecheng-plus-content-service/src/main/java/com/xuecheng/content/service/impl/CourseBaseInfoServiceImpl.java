...
public class CourseBaseInfoServiceImpl implements CourseBaseInfoService {
    ...
    public PageResult<CourseBase> queryCourseBaseList(PageParams pageParams, QueryCourseParamsDto courseParamsDto) {
        ...
        //按课程发布状态查询 course_base.publish_stauts = ?
...
//        courseBaseNew.setDescription(dto.getDescription());
    ...
    public CourseBaseInfoDto getCourseBaseInfo(long courseId){
        ...
        //todo：课程分类的名称设置到courseBaseInfoDto 已完成
        //设置课程分类名称
        CourseCategory courseCategory1 = courseCategoryMapper.selectById(courseBase.getSt());
        String stName = courseCategory1.getName();
        String mtName = courseCategoryMapper.selectById(courseCategory1.getParentid()).getName();
    ...
    public CourseBaseInfoDto updateCourseBase(EditCourseDto editCourseDto) {
        CourseBase courseBaseNew = new CourseBase();
        BeanUtils.copyProperties(editCourseDto,courseBaseNew);//只要属性名称一致就可以拷贝
    ...
    public void deleteById(Long id) {
        ...
        {
            XueChengPlusException.cast("课程审核状态异常");
        }
    }
